...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("PlayerEntity")));
bytes32 constant PlayerEntityTableId = _tableId;

library PlayerEntity {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("PlayerEntity", _fieldNames);
  }
