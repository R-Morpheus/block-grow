...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("Transaction")));
bytes32 constant TransactionTableId = _tableId;
...
library Transaction {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("Transaction", _fieldNames);
  }
