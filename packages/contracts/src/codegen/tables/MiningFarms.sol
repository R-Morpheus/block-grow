...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("MiningFarms")));
bytes32 constant MiningFarmsTableId = _tableId;
...
library MiningFarms {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("MiningFarms", _fieldNames);
  }
