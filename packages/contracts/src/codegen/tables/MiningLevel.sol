...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("MiningLevel")));
bytes32 constant MiningLevelTableId = _tableId;
...
library MiningLevel {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("MiningLevel", _fieldNames);
  }
  ...
  function set(IStore _store, bytes32 entity, uint8 value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entity;
