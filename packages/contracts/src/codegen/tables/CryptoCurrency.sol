...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CryptoCurrency")));
bytes32 constant CryptoCurrencyTableId = _tableId;
...
library CryptoCurrency {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CryptoCurrency", _fieldNames);
  }
